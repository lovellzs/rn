    ...
    render() {
        return (
            <View>
                ...
                <CustomButton url={'llzs://reactnative.vip/data'} text="打开DouBanMovie"/>
                <CustomButton url={'sz://reactnative.vip/data'} text="自己打开自己"/>
            </View>
        );
    }
}
...
AppRegistry.registerComponent('AwesomeProject', () => LinkingDemo);